...
// goToConversation(1);
  ...
  return (
    <Layout navbar = {<> <div className='left-orient left-orient2' style={{ fontSize: '1rem', background: 'rgba(14, 16, 38, 0)', paddingRight: '4rem', maxWidth: '100vw'}}> 
             ...
             <li><Link reloadDocument to='/courses/flb/schizophrenia'> Photosynthesis</Link></li>
              <li><Link reloadDocument to='/courses/flb/cbt'>Respiration</Link></li>
              <li><Link reloadDocument to='/courses/flb/comparing'>Osmosis</Link></li>
              <li><Link reloadDocument to='/courses/flb/schizophrenia'>Amoeba Binary Fission</Link></li>
              <li><Link reloadDocument to='/courses/flb/cbt'>Presence of starch</Link></li>
              <li><Link reloadDocument to='/courses/flb/comparing'>Comparing yourself</Link></li>
